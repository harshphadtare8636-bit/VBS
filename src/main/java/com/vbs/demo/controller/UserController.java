...
public class UserController {
    ...
    User user = userRepo.findByUsername(u.getUsername()); //comparing with database user with u to get values
    if(user==null)
    {
...
// add or in passbook will show all transacion
    ...
    // deleting of users or History of users
    ...
    // admin dashboard controls to find customer
    @GetMapping("/users")
